...
class G4MTritium : public G4Ions
{
 private:
   static G4MTritium* theInstance;
  G4MTritium(){};
  ~G4MTritium(){};

 public:
   static G4MTritium* Definition();
   static G4MTritium* TritiumDefinition();
   static G4MTritium* Tritium();
};
