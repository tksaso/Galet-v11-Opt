...
int main(int argc,char** argv)
{
  ...
  //
  GaletDetectorConstruction* detConstruction = new GaletDetectorConstruction();
  runManager->SetUserInitialization(detConstruction);

  //G4VModularPhysicsList* physicsList = new FTFP_BERT;
  G4VModularPhysicsList* physicsList = new MACPhysicsList;
  runManager->SetUserInitialization(physicsList);
    
  GaletActionInitialization* actionInitialization
     = new GaletActionInitialization();
